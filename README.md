...
* <a href="https://app.diagrams.net/?splash=0&clibs=Uhttps%3A%2F%2Fjgraph.github.io%2Fdrawio-libs%2Flibs%2Fgithub%2Fgithub-octicons.xml" target="_blank">GitHub Octicons:</a> GitHub's official <a href="https://primer.style/octicons/" target="_blank">Octicons</a> — 377 recolorable development and UI icons (MIT) from <a href="https://github.com/primer/octicons" target="_blank">primer/octicons</a> v19.32.0 (August 2026). 24px masters with viewBox cropped to ink; icons missing upstream at 24px are derived from the 16px originals. GitHub brand marks (Invertocat, logos) are intentionally excluded.
