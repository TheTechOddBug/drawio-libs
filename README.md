...
* <a href="https://app.diagrams.net/?splash=0&clibs=Uhttps%3A%2F%2Fjgraph.github.io%2Fdrawio-libs%2Flibs%2Fgithub%2Fgithub-octicons.xml" target="_blank">GitHub Octicons:</a> GitHub's official <a href="https://primer.style/octicons/" target="_blank">Octicons</a> — 381 recolorable development and UI icons (MIT) from <a href="https://github.com/primer/octicons" target="_blank">primer/octicons</a> v19.32.0 (August 2026). 24px masters with viewBox cropped to ink; icons missing upstream at 24px are derived from the 16px originals. Includes GitHub brand marks (Invertocat, logos), subject to GitHub's logo policy.
...
* <a href="https://app.diagrams.net/?splash=0&clibs=Uhttps%3A%2F%2Fjgraph.github.io%2Fdrawio-libs%2Flibs%2Foci%2Foci-icons.xml" target="_blank">OCI Icons:</a> Open Container Initiative <a href="https://github.com/opencontainers/artwork" target="_blank">artwork</a> concept icons — 65 recolorable container-infrastructure icons (Apache-2.0), snapshot d8ccfe9 (July 2026).
* <a href="https://app.diagrams.net/?splash=0&clibs=Uhttps%3A%2F%2Fjgraph.github.io%2Fdrawio-libs%2Flibs%2Foci%2Foci-logos.xml" target="_blank">OCI Logos:</a> Official OCI, runc and OCI Certified logo variants from the same <a href="https://github.com/opencontainers/artwork" target="_blank">artwork</a> repo — 15 entries (Apache-2.0), snapshot d8ccfe9 (July 2026). Use of the marks is subject to the <a href="https://www.linuxfoundation.org/legal/trademark-usage" target="_blank">Linux Foundation trademark policy</a>.
